...
PORTA_MQTT = 8883  # Porta segura
CLIENT_ID = "gateway_python_A2F"
MQTT_USER = "seu_token_ou_usuario"
MQTT_PASSWORD = "sua_senha_se_houve"
...
# Se estiver usando a porta 8883 (TLS), descomente a linha abaixo:
...
print(f"[MQTT] Conectando ao broker {BROKER} na porta {PORTA_MQTT}...")
client.connect(BROKER, PORTA_MQTT, keepalive=60)
client.loop_start()   # Inicia a thread de fundo para gerenciar a conexão e mensagens
